...
const ContactForm = () => {
    return (
        <div className="bg-white rounded-xl p-6 md:p-10 max-w-7xl mx-auto flex flex-col md:flex-row gap-10 items-center md:items-start justify-between">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 md:mb-4">Reach out to us by<br/>
                filling the form</h1>
