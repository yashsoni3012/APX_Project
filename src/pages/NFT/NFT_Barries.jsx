...
const NFT_Barries = () => {
    return (    
        <div className="px- sm:px-6 lg:px-20 py-2 bg-white">
            <div className="max-w-7xl mx-auto mb-10 text-center">
                ...
                <p className="mx-auto text-center w-full sm:w-[80%] md:w-[60%] lg:w-[40%] text-sm sm:text-base md:text-lg text-black mt-4 italic">
