        ...
        <div className="flex flex-col md:flex-row max-w-full mx-auto mt-10 mb-10 overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-6 sm:p-10 flex flex-col justify-between items-start" style={{ backgroundColor: '#151515' }}>
                ...
                <div className='ml-0 md:ml-20'>
                    ...
                    <p className="text-white text-sm sm:text-base leading-relaxed font-semibold space-y-2">
                ...
                {/* Left-aligned Button */}
                <button className="mt-8 bg-green-600 text-white py-3 px-12 sm:px-16 rounded-md font-semibold hover:bg-green-700 transition-colors w-full sm:w-auto ml-0 md:ml-20">
                    Join The Movement
                </button>
            </div>
